  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        leading:
            IconButton(icon: const Icon(Icons.menu), onPressed: () => print("menu"),),
        actions: [
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: const Center(child: Text("+",style: TextStyle(fontWeight: FontWeight.w700),)),
                  ),
                  const DepositItem(name: "Fast Invest",detail: "7.5% per month",icon: Icon(Icons.bar_chart,color: Colors.blue,),),
                  const DepositItem(name: "daily Invest",detail: "0.5% per month",icon: Icon(Icons.bar_chart,color: Colors.greenAccent,),),
                  const DepositItem(name: "monthly Invest",detail: "6.5% per month",icon: Icon(Icons.bar_chart,color: Colors.orangeAccent,),)
